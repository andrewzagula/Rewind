...
from engine.strategy_validator import StrategyValidation, validate_strategy_code
...
def _normalize_create_strategy_and_run_payload(
    ...
    if isinstance(raw_code, str) and raw_code.strip():
        ...
        errors.append(
            f"{prefix} create_strategy_and_run requires payload.code "
            "or one valid generated strategy block."
        )
        return None
